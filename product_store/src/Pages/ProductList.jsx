  ...
  return (
    <div className="flex flex-col md:flex-row">
      ...
      {loading ? (
        ...
        <div className="text-white text-2xl overflow-auto font-bold shadow-lg p-4 border rounded-lg h-20 m-20">NO DATA AVAILABLE</div>
      ) : (
                ...
                <Link to={`/products/${product.id}`}>
                  <div className="relative flex flex-col transition duration-300 ease-in-out transform hover:scale-105 text-gray-700 bg-gray-100 shadow-md bg-clip-border rounded-xl">
                    ...
                    <div className="p-6 pt-0">
                      <button className="align-middle select-none font-sans font-bold text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 px-6 border rounded-lg shadow-gray-900/10 hover:shadow-gray-900/20 focus:opacity-[0.85] active:opacity-[0.85] active:shadow-none block w-full bg-blue-gray-900/10 text-blue-gray-900 shadow-none hover:scale-105 hover:shadow-none focus:scale-105 focus:shadow-none active:scale-100">
                        Add to cart
                      </button>
                    </div>
                  </div>
